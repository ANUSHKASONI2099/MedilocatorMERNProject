...
function UserRegistration() {
    ...
    return (
        ...
        <>
            ...
            <h1 style={{ textAlign: "center", fontFamily: "cursive", color: "black", marginTop: "2%" }}>"Add Your Pharmacy Details and Go Live"</h1>
            ...
            <div style={{ display: "flex" }}>
                ...
                <div style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-start', padding: '40px', flexWrap: 'wrap', marginLeft: "5%", marginTop: "5%" }}>
                    <div style={{ flex: '1', minWidth: '300px', maxWidth: '400px', padding: '20px', borderRadius: '15px', }}>
                        ...
                        <h5>
                            Get Listed on <strong>MediLocator</strong>
                        </h5>
                        <p>
                            Register yourself and let people around you easily find your store when they need it most.
                        </p>
                        <h6>
                            Connecting pharmacies to people — one click at a time. 🔗💊
                        </h6>
                ...
                <form onSubmit={submitData} style={{ height: "740px", width: "600px", backgroundColor: "lightblue", padding: "4%", marginLeft: "9%", boxShadow: "5px 5px 5px grey", marginTop: "3%" }}>
                    ...
                    <div className="input-group mb-3 w-75 mx-auto">
                        ...
                        <input type="email" name="email" className="form-control" placeholder="Enter Email" value={regData.email} onChange={fetchData}  />
                    </div>
                    <br />
                    <div className="input-group mb-3 w-75 mx-auto">
                        <span className="input-group-text"> <i className="fa-solid fa-key"></i> </span>
                        <input type="password" name="password" className="form-control" placeholder="Enter password" value={regData.password} onChange={fetchData} />
                    </div>
                    <br />
                    <div className="input-group mb-3 w-75 mx-auto">
                        <span className="input-group-text"> <i className="fa-regular fa-address-card"></i> </span>
                        <input type="text" name="name" className="form-control" placeholder="Enter Name" value={regData.name} onChange={fetchData} />
                    </div>
                    <br />

                    <div className="input-group mb-3 w-75 mx-auto">
                        <span className="input-group-text">  <i className="fa-solid fa-phone"></i></span>
                        <input type="number" name="phone" className="form-control" placeholder="Enter phone number" value={regData.phone} onChange={fetchData} />
                    </div>
                    <br />
                    <div className="input-group mb-3 w-75 mx-auto">
                        <span className="input-group-text">  <i className="fa-solid fa-location-dot"></i></span>
                        <input type="text" name="city" className="form-control" placeholder="Enter city" value={regData.city} onChange={fetchData} />
                    </div>

                    <br />

                    <label htmlFor="imageUpload">Upload Image:</label>
                    <input type="file" id="imageUpload" name="pic" onChange={fetchData} ref={fileInputRef} />
                    <br />
                    <br />
                    <br />
                    <label htmlFor="address">Address:</label><br />
                    <textarea id="address" name="address" rows="4" cols="50" placeholder="Enter your address here" value={regData.address} onChange={fetchData}></textarea>
