...
<div className="offcanvas offcanvas-start" style={{backgroundColor:"#5b6097ff",width:"20%",marginTop:"50px"}} tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
